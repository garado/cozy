...
function progressbar.new(args)
    ...
    awesome.connect_signal("theme::reload", function(lut)
        pbar._private.border_color = lut[pbar._private.border_color]
        pbar._private.color = lut[pbar._private.color]
        pbar._private.background_color = lut[pbar._private.background_color]
    end)
