...
local journal_yes = naughty.action { 
  name = helpers.ui.colorize_text("Yes", beautiful.fg_0)
}
...
local journal_no = naughty.action {
  name = helpers.ui.colorize_text("No", beautiful.fg_0),
}
...
local sleep_yes = naughty.action { 
  name = helpers.ui.colorize_text("Okay.", beautiful.fg_0) 
}
...
local sleep_no = naughty.action { 
  name = helpers.ui.colorize_text("Nah.", beautiful.fg_0) 
}
