...
local function create_habit_ui_entry(name, graph_id, frequency)
  ...
  local freq = wibox.widget({
    markup = helpers.ui.colorize_text(frequency, beautiful.hab_freq),
...
local container = helpers.ui.create_boxed_widget(habit_widget, dpi(550), dpi(410), beautiful.dash_widget_bg)
